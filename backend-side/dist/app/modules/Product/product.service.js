...
const savingProductToDB = (product) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield product_model_1.Product.create(product);
    return result;
});
const getAllProductDataFromDB = (terms) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield product_model_1.Product.find(terms || {}).populate('owner');
    return result;
});
