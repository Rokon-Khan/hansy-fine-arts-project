...
// const UpdateArtForm = ({ handleUpdate, artData }) => {
...
//               <textarea
//                 id="description"
//                 placeholder="Write art description here..."
...
// UpdateArtForm.propTypes = {
//   handleUpdate: PropTypes.func.isRequired,
//   artData: PropTypes.object.isRequired,
// };
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-1 text-sm">
              ...
              <select
                ...
                name="category"
                defaultValue={artData.category}
              >
                <option value="abstract">Abstract & Design</option>
                <option value="contemporary">Contemporary</option>
                <option value="portrait">Custom Portrait</option>
                <option value="artsy">Artsy Product</option>
              </select>
            </div>
            ...
            <div className="flex justify-between gap-2">
              ...
              <div className="space-y-1 text-sm">
                ...
                <input
                  ...
                  id="sku"
                  type="text"
                  defaultValue={artData.sku}
                  placeholder="Art Product SKU"
                  required
                />
              </div>
