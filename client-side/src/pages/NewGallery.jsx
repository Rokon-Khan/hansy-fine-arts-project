      ...
      <div className="grid grid-cols-3 gap-10">
        {categories[selectedCategory].map((item) => (
          <div key={item.id} className="relative group text-center">
            <div className="relative overflow-hidden shadow-lg transition-transform duration-300 ease-in-out transform group-hover:scale-105">
              <div className="border-8 border-zinc-400 absolute inset-0 pointer-events-none"></div>
              <img
                src={item.image}
                alt={item.title}
                className="w-full h-40 object-cover border-pink-400"
              />
